...
cmd = """
echo "=== Check apt / dpkg running processes ==="
ps aux | grep -E "apt|dpkg" | grep -v grep
echo "=== Check dpkg lock status ==="
fuser /var/lib/dpkg/lock-frontend || true
echo "=== Check fail2ban status ==="
which fail2ban-client || true
echo "=== Journalctl of armguard ==="
journalctl -u armguard -n 30 --no-pager
"""
