...
cmd = """
echo "=== 1. Test Real Sites API ==="
curl -s -6 http://[::1]:8888/api/v1/sites
echo ""

echo "=== 2. Test Real Databases API ==="
curl -s -6 http://[::1]:8888/api/v1/databases
echo ""

echo "=== 3. Test Real Docker Containers API ==="
curl -s -6 http://[::1]:8888/api/v1/docker/containers
echo ""

echo "=== 4. Test Real Crontab API ==="
curl -s -6 http://[::1]:8888/api/v1/crontabs
echo ""
"""
