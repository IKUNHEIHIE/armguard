...
cmd = """
echo "=== 1. Create real Nginx site via API ==="
curl -s -6 -X POST http://[::1]:8888/api/v1/sites -H "Content-Type: application/json" -d '{"domain": "demo.arm.local", "path": "/www/wwwroot/demo.arm.local"}'
echo ""
echo "=== 2. Check generated Nginx config file ==="
cat /etc/nginx/conf.d/demo.arm.local.conf
echo ""
