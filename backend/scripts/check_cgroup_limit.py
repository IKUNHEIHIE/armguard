...
print("=== Check /etc/systemd/system/armguard.service ===")
stdin, stdout, stderr = ssh.exec_command("cat /etc/systemd/system/armguard.service")
print(stdout.read().decode('utf-8'))

print("=== Check Total System Free Memory ===")
stdin, stdout, stderr = ssh.exec_command("free -h")
print(stdout.read().decode('utf-8'))

print("=== Check apt-get status ===")
stdin, stdout, stderr = ssh.exec_command("ps aux | grep apt")
print(stdout.read().decode('utf-8'))
