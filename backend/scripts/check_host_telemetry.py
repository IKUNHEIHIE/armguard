...
cmd = """
echo "=== Host Thermal Zones ==="
ls -l /sys/class/thermal/ 2>/dev/null || true
cat /sys/class/thermal/thermal_zone*/temp 2>/dev/null || echo "No standard thermal zone temp"

echo "=== Host Memory (/proc/meminfo) ==="
