...
run("uname -a")
run("modprobe wireguard && echo 'Kernel WireGuard module is available' || echo 'Kernel WireGuard failed'")
run("which wg wg-quick resolvconf ip")
run("which go curl wget")
run("which wireguard-go wgcf")
