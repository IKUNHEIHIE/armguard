...
cmd = """
DEBIAN_FRONTEND=noninteractive apt-get install -y -qq sqlite3 nginx docker.io 2>&1
mkdir -p /www/wwwroot /www/server /var/backups/armguard /etc/armguard/ssl /etc/armguard/sites
echo "=== Nginx & SQLite3 installed ==="
sqlite3 --version
nginx -v
"""
